Project Overview
This project analyzes churn patterns in a B2B SaaS environment using a dataset of 30,000+ records. The analysis focuses on the "Satisfaction Paradox"—a phenomenon where high support satisfaction scores (4.0/5.0) mask underlying loyalty risks caused by product feature gaps.
...
02_Data_load_and_cleaning.py: Median imputation and data standardization.
